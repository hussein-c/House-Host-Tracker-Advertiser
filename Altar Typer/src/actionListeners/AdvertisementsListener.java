...
public class AdvertisementsListener {
	...
	public static JTextField noHostAdvert = new JTextField(StartupSettings.noHostMessage);
	public static JTextArea communityAdverts = new JTextArea(StartupSettings.communityMessages);
	public static JTextArea boneJobAdverts = new JTextArea(StartupSettings.boneJobMessages);
	...
	public static void advertisementsPanel() {
		...
		noHostAdvert = new JTextField(StartupSettings.noHostMessage);
		...
		communityAdverts = new JTextArea(StartupSettings.communityMessages);
		...
		boneJobAdverts = new JTextArea(StartupSettings.boneJobMessages);
		...
		int confirmation = JOptionPane.showOptionDialog(StartupSettings.frame, advertisementsPanel,
		...
		if (confirmation == JOptionPane.OK_OPTION) {
			...
			JOptionPane.showMessageDialog(StartupSettings.frame, "Any changes you made have now been applied.", "Advertisements", JOptionPane.INFORMATION_MESSAGE);
		}
		else {
			return;
		}
