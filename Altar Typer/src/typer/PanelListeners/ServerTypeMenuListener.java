...
public class ServerTypeMenuListener {
	...
	public static void setCommunityAdvertisementsText() {
		...
		Settings.noHostMessage = AdvertisementsListener.noHostAdvert.getText();
		Settings.communityMessages = AdvertisementsListener.communityAdverts.getText();
		Settings.boneJobMessages = AdvertisementsListener.boneJobAdverts.getText();
	}
}