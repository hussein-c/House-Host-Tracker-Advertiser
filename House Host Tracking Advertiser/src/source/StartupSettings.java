...
/**
 * Note: The Altar.rs web server got taken down by the owner due to real life
 * circumstances, and as such, the application is currently not grabbing any web
 * page data.
 * I am not offering a license for this repository.
 * Copyright © 2022-present. All rights reserved.
 * Written by Mr Dakota N. and myself (Hussein C). I have been granted complete
...
public class StartupSettings {
	...
	public static void startProgram() {
		try { // This is important on MacOS because it allows it to look like the Windows
					// version
	...
	public static void initialiseSettings() { // Initialises all settings upon application start-up based on the
