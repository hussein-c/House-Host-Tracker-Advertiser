...
public class ConfigsListener {
	...
	public static void configsPanel() {
		...
		String numericErrorMessage = "Enter only numeric digits (0-9).";
		JLabel typeSpeedDelayMin = new JLabel("Minimum Typing Speed (1 millisecond or more):");
		typeSpeedDelayMin.setBounds(0, 30, 275, 20);
		JTextField typeSpeedDelayMinField = new JTextField("" + StartupSettings.adjustTyperSettings.getTypeSpeedDelayMin());
		...
		typeSpeedDelayMinField.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent key) {
				...
				if ((key.getKeyCode() == KeyEvent.VK_BACK_SPACE || (key.getKeyCode()>=48 && key.getKeyCode()<=57))) {
					...
					typeSpeedDelayMinValidation.setText(numericErrorMessage);
				}
			}
		});
		...
		JTextField typeSpeedDelayMaxField = new JTextField("" + StartupSettings.adjustTyperSettings.getTypeSpeedDelayMax());
		...
		typeSpeedDelayMaxField.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent key) {
				...
				if ((key.getKeyCode() == KeyEvent.VK_BACK_SPACE || (key.getKeyCode()>=48 && key.getKeyCode()<=57))) {
					...
					typeSpeedDelayMaxValidation.setText(numericErrorMessage);
				}
			}
		});
		...
		JTextField delayTimeMinField = new JTextField("" + StartupSettings.adjustTyperSettings.getDelayTimeMin() / 1000);
		...
		delayTimeMinField.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent key) {
				...
				if ((key.getKeyCode() == KeyEvent.VK_BACK_SPACE || (key.getKeyCode()>=48 && key.getKeyCode()<=57))) {
					...
					delayTimeMinValidation.setText(numericErrorMessage);
				}
			}
		});
		...
		JTextField delayTimeMaxField = new JTextField("" + StartupSettings.adjustTyperSettings.getDelayTimeMax() / 1000);
		...
		delayTimeMaxField.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent key) {
				...
				if ((key.getKeyCode() == KeyEvent.VK_BACK_SPACE || (key.getKeyCode()>=48 && key.getKeyCode()<=57))) {
					...
					delayTimeMaxValidation.setText(numericErrorMessage);
				}
			}
		});
		...
		JTextField stopTimeField = new JTextField("" + StartupSettings.adjustTyperSettings.getStopTime() / 3600);
		...
		stopTimeField.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent key) {
				...
				if ((key.getKeyCode() == KeyEvent.VK_BACK_SPACE || (key.getKeyCode()>=48 && key.getKeyCode()<=57))) {
					...
					stopTimeValidation.setText(numericErrorMessage);
				}
			}
		});
		...
		JTextField hostCountField = new JTextField("" + StartupSettings.adjustTyperSettings.getHostCount());
		...
		hostCountField.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent key) {
				...
				if ((key.getKeyCode() == KeyEvent.VK_BACK_SPACE || (key.getKeyCode()>=48 && key.getKeyCode()<=57))) {
					...
					hostCountValidation.setText(numericErrorMessage);
				}
			}
		});
		...
		int confirmation = JOptionPane.showOptionDialog(StartupSettings.frame, configsPanel,
		...
		if (confirmation == JOptionPane.OK_OPTION) {
			...
			if ((Integer.parseInt(typeSpeedDelayMinField.getText()) > 0 && Integer.parseInt(typeSpeedDelayMaxField.getText()) > 0) && (Integer.parseInt(typeSpeedDelayMinField.getText()) <= Integer.parseInt(typeSpeedDelayMaxField.getText()))) {
				StartupSettings.adjustTyperSettings.setTypeSpeedDelayMin(Integer.parseInt(typeSpeedDelayMinField.getText()));
				StartupSettings.adjustTyperSettings.setTypeSpeedDelayMax(Integer.parseInt(typeSpeedDelayMaxField.getText()));
			}
			...
			if ((Integer.parseInt(delayTimeMinField.getText()) > 0 && Integer.parseInt(delayTimeMaxField.getText()) > 0) && (Integer.parseInt(delayTimeMinField.getText()) <= Integer.parseInt(delayTimeMaxField.getText()))) {
				StartupSettings.adjustTyperSettings.setDelayTimeMin(Integer.parseInt(delayTimeMinField.getText()) * 1000);
				StartupSettings.adjustTyperSettings.setDelayTimeMax(Integer.parseInt(delayTimeMaxField.getText()) * 1000);
			}
			...
			if (Integer.parseInt(stopTimeField.getText()) > 0) {
				StartupSettings.adjustTyperSettings.setStopTime(Integer.parseInt(stopTimeField.getText()) * 3600);
			}
			else {
				errorFlag = true;
				count++;
			...
			if (Integer.parseInt(hostCountField.getText()) > 0) {
				StartupSettings.adjustTyperSettings.setHostCount(Integer.parseInt(hostCountField.getText()));
			}
			else {
				errorFlag = true;
				count++;
			...
			if (errorFlag == true) {
				...
				JOptionPane.showMessageDialog(StartupSettings.frame, errorMessage, "Error", JOptionPane.ERROR_MESSAGE);
			}
			else {
				Config.updateConfigFile();
				StartupSettings.initialiseSettings();
				JOptionPane.showMessageDialog(StartupSettings.frame, "Any changes you made have now been applied.", "Configs", JOptionPane.INFORMATION_MESSAGE);
			}
		}
		else {
			return;
